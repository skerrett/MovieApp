...
public class Activity8 extends AppCompatActivity implements  MovieAdapter.onItemClickListener{
    ...
    private void getLengthMore(int text) {
        Call<List<Movie>> call = movieActorsApi.getRuntimeMore(text);
        ...
        call.enqueue(new Callback<List<Movie>>() {
            ...
            public void onResponse(Call<List<Movie>> call, Response<List<Movie>> response) {
                ...
                movieAdapter.setOnItemClickListnerer(Activity8.this);
            }
